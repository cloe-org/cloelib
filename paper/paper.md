...
Within this protocol-based framework, the library interfaces with several well-established Boltzmann solvers, including \texttt{CAMB}, \texttt{CLASS}, and their extensions [e.g. \texttt{hi_class} [@hi_class_1 @hi_class_2], \texttt{mgclass} II [@Sakr_2022], \texttt{mochi_class} [@mochi_class]], as well as other non-linear model extensions and emulators [i.e. \texttt{ReACT} [@ReACT]].
