...
class w0waCDM_3degen_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("w0wa+3degen_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
...
class w0waCDM_1mass_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("w0wa+1mass_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
...
class w0waCDM_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("w0wa_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
...
class LCDM_3degen_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("3degen_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
...
class LCDM_1mass_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("1mass_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
...
class LCDM_Pcb_Linear:
    ...
    def __init__(self, background : Background, redshifts: np.ndarray):
        ...
        with warnings.catch_warnings():
            ...
            cp_file = emulator_data("lcdm_pcb-linear-spectra.pkl", zenodo_path)
            self.cp_LIN = cp.cosmopower_NN(restore=True, restore_filename=cp_file)
