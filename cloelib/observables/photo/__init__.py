...
(`GalaxyBiasContribution`, `MagnificationContribution`,
`NonLinearGalaxyBiasContribution`, `PBJNonlinearBiasLoopComputer`) live
together in `photo.positions`. The generic, tracer-agnostic pieces both of those (and
