...
We use the [All Contributors bot](https://allcontributors.org/) to recognize contributions of all types — not just code!
...
```
@all-contributors please add @whoever for code, doc
```

The bot will open a pull request to update the `README.md` with the new contributor badge. Once approved, the contributor will be publicly acknowledged.

> 📚 See the full list of contribution types [here](https://allcontributors.org/docs/en/emoji-key).

## 🛠️ Maintenance of cloelib
